...
\newcommand{\thesistitle}{Search for Higgs Boson Pair Production in
  $\bbbar\tautau$ Final States with the ATLAS Experiment at the LHC}

\newcommand*{\thesisauthor}{Christopher Deutsch}
\newcommand*{\thesistown}{Sinzig}
...
\newcommand*{\thesisrefereeone}{Prof.\ Dr.\ Jochen C.\ Dingfelder}
\newcommand*{\thesisrefereetwotext}{2.\ Gutachter}
\newcommand*{\thesisrefereetwo}{Prof.\ Dr.\ Ian C.\ Brock}
...
\input{chapters/theory/sm_overview}
\input{chapters/theory/symmetries_interactions}
\input{chapters/theory/higgs_boson}
\input{chapters/theory/bsm}
\input{chapters/theory/experimental_status}

% \clearpage
% \todo[inline]{Here be dragons!}
% \input{chapters/theory/collider_physics}

% ==============================================================================
\chapter{The ATLAS Experiment at the Large Hadron Collider}%
\label{sec:atlas_and_lhc}
% ==============================================================================
\input{chapters/lhc_atlas/intro}
\input{chapters/lhc_atlas/lhc}
\input{chapters/lhc_atlas/atlas}
\input{chapters/lhc_atlas/object_reco}
...
% ==============================================================================
% \input{chapters/experimental_methods/trigger}
\input{chapters/experimental_methods/intro}
\input{chapters/experimental_methods/statistical_methods}
\input{chapters/experimental_methods/ml}

% ==============================================================================
\chapter{Tau Identification with Neural Networks}%
\label{sec:tauid}
% ==============================================================================
\input{chapters/tau_identification/intro}
\input{chapters/tau_identification/simulation}
\input{chapters/tau_identification/rnn_tauid}
\input{chapters/tau_identification/rnn_tauid_perf}
\input{chapters/tau_identification/conclusion}
...
\label{sec:dihiggs}
% ==============================================================================
\input{chapters/higgs_pair_production/introduction}
\input{chapters/higgs_pair_production/data_and_simulation}
\input{chapters/higgs_pair_production/event_reconstruction}
\input{chapters/higgs_pair_production/event_selection}
\input{chapters/higgs_pair_production/background_estimation}
\input{chapters/higgs_pair_production/multivariate_analysis}
\input{chapters/higgs_pair_production/uncertainties}
\input{chapters/higgs_pair_production/statistical_analysis}
\input{chapters/higgs_pair_production/discussion}
...
% ==============================================================================
\input{chapters/higgs_self_coupling/self_coupling}
