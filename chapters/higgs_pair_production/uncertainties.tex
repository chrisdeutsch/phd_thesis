...
region. The difference is assigned as an additional uncertainty in
both channels for all mass points simulated using \textsc{ATLFAST-II}
(i.e.\ $\mX \leq \SI{1000}{\GeV}$).
