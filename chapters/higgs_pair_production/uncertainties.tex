...
theoretical cross section predictions and thus both cross section and
...
production because the cross section~$\sigma(pp \to X \to HH)$ is considered to
be the POI. However, uncertainties on the Higgs boson branching ratios are taken
into account.
