...
\end{description}
These variations are used to estimate the relative acceptance uncertainties for the \ZHF background according to \Cref{eq:relative_acceptance_uncertainty} and are summarised in \Cref{tab:uncertainties_zhf_extrapol}.
