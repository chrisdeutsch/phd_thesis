...
\item[Single SM $H$ production] Cross section uncertainties for all SM
  $H$ production processes are assigned according to the
  recommendations outlined in Ref.~\cite{deFlorian:2016spz}.

  Uncertainties on the branching ratios of
  $\PHiggs \to \tautau$ and $\PHiggs \to \bbbar$ for
  $m_{\PHiggs} = \SI{125.0}{\GeV}$ are assigned where applicable and
