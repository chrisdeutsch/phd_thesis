...
Uncertainties related to the reconstruction and selection of physics
...
summarised in \Cref{tab:experimental_uncertainties_2}. Uncertainties
...
% calibrations and uncertainties that are
% sensitive to the modelling of the calorimeter response are
% specifically derived for simulated event samples using \emph{fast
...
\todo[inline]{This might need a separate section if data-driven
  background uncertainties are all moved here.}

Experimental uncertainties on the \faketauhadvis background estimate
