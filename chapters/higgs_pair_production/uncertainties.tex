...
%     ($Z+bb$, $Z+bc$, $Z+cc$) in the three signal regions. The relative
...
The shape effects on the \ZHF background are propagated to the
...
% We have the following shape uncertainties
%
% ttbar:
%
% THEO_ACC_TTBAR_ME
% THEO_ACC_TTBAR_PS_HadHad
% THEO_ACC_TTBAR_ISR
%
% Lephad only
% THEO_ACC_TTBAR_PS_SLT
% THEO_ACC_TTBAR_FSR
%
% Z+hf:
% THEO_ACC_Zhf_GENERATOR
% THEO_ACC_Zhf_SCALE
