...
\item[2018 data-taking period] New HLT algorithms were introduced for \tauhadvis
  ...
  processes of about \SI{5}{\percent} compared to the \FourJTwelve trigger
  without the $|\eta| < 2.3$ requirement on jets. This issue is resolved in the
  trigger menu of the ATLAS experiment for Run~3 of the LHC.
\end{description}
