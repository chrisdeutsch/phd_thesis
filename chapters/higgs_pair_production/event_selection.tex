...
observables is not the goal of the event selection but rather of a
multivariate analysis that will be introduced at a later stage (in
...
\item All events considered in the analysis are required to fulfil the
  data quality criteria by the ATLAS collaboration~\cite{DAPR-2018-01}
  requiring stable beams at the LHC and a fully operational detector.
...
\begin{table}[htbp]
  ...
  \caption{Event selection. Exact \pT thresholds vary with the
    triggers (the range is given). For taus in hadhad and jets thresholds are }%
...

  {
    ...
    \begin{tabular}{C{0.22\textwidth}C{0.22\textwidth}C{0.22\textwidth}C{0.22\textwidth}}
      ...
      \midrule
      \multicolumn{4}{c}{\textbf{\tauhadvis selection}} \\
      \midrule
      \multicolumn{2}{c}{Exactly two \tauhadvis} & \multicolumn{2}{c}{Exactly one \tauhadvis} \\[0.5em]
                                                   && \multicolumn{2}{c}{$|\eta| < 2.3$} \\[0.5em]
      $\pT > 100\text{-}180 \, (25)\,\si{\GeV}$ & $\pT > 40 \, (30)\,\si{\GeV}$ & & \\
      \midrule
      \multicolumn{4}{c}{\textbf{Jet selection}} \\
      \midrule
      \multicolumn{4}{c}{$\geq 2$ jets with $|\eta| < 2.5$}\\[0.5em]
      $\geq 1$ jet with $\pT > \SI{45}{\GeV}$ & trigger-dependent$^\dagger$ & $\geq 1$ jet with $\pT > \SI{45}{\GeV}$ & trigger-dependent \\
      \midrule
      \multicolumn{4}{c}{\textbf{Event-level selection}} \\
      \midrule
      \multicolumn{4}{c}{$\mMMC > \SI{60}{\GeV}$} \\
...
\todo[inline]{Reconstruction of Hbb and Htautau candidates incl.\ MMC
  and $b$-jet energy corrections.}
