...
reconstruction becomes less effective at resolving the decay products.
% such that their decay products cannot be resolved using the object
% reconstruction techniques employed in this search.
Dedicated searches for scalar resonances with masses of up to \SI{3}{\TeV}
decaying into Higgs boson pairs were performed by the ATLAS collaboration in the
$\bbbar\hadhad$ final state using special reconstruction techniques in
Ref.~\cite{HDBS-2019-22}.
