...
reason for using a loosened object selection is twofold: First, the \tauhadvis
...
used previously. This allows to adopt looser object selection criteria while
...
multivariate methods. As a result, the signal sensitivity of this analysis
...
\begin{table}[htbp]
  ...
  \caption{Signal acceptance of the SR selections in all three channels. The
    ...
    data~\cite{HIGG-2016-16-witherratum}. $\dagger$:~The SM \HH \AccTimesEff is
    given for the combination of \lephad SLT and LTT channel.}%
