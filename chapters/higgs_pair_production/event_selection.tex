...
An overview of the signal region event selection for all search channels is
given in \Cref{tab:event_selection}. A more detailed description of the \hadhad
...
\begin{table}[htbp]
  ...
  \caption{Summary of the signal region event selections for the \hadhad,
    ...
    described in \Cref{sec:hadhad_trigger_selection}. Jets in the forward region
    are not used for event selection purposes. Requirements from the object
    selection introduced in \Cref{sec:object_reconstruction} are assumed to
