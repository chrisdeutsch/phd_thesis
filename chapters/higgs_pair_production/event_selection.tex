...
\begin{table}[htbp]
  ...
  \caption{Event selection. Exact \pT thresholds vary with the
    triggers (the range is given). For taus in hadhad and jets
    thresholds are trigger-dependent. Forward jets are not used to
    select events (only to calculate MET). Requirements applied as
    part of the object selection are not repeated here.}%
