...
All events considered in the analysis are required to fulfil the data
quality criteria by the ATLAS collaboration~\cite{DAPR-2018-01}
...
Events containing one or more jets that are classified as originating
