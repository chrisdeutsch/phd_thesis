...
channel. This increase results from improved \tauhadvis reconstruction
...
used to distinguish between signal events and events containing jets that are
...
\begin{table}[htbp]
  ...
  \caption{SM~\HH \AccTimesEff of the SR selections in all three channels. The
...
efficiencies at event-level due to the selection of two $b$-tagged jets and two
(one) reconstructed and identified \tauhadvis in the SR of the \hadhad (\lephad)
channel. These changes explain the majority of the increase in \AccTimesEff for
SM~\HH with respect to the previous search by the ATLAS collaboration in this
channel.
...
\begin{figure}[htbp]
  ...
  \caption{The \AccTimesEff for events from scalar resonances decaying into
    Higgs boson pairs. It is shown as a function of the resonance mass, \mX, and
...
of the \hadhad channel is shown in~\Cref{tab:cutflow}. Most events are rejected
due to the trigger selection, the \tauhadvis candidate selection, or the
requirement of two \btagged jets in the SR.
