...
flavour (\ZHF) is defined in \Cref{sec:bkg_zjets} providing constraints on the
...
region. This method is described in \Cref{sec:bkg_hadhad_ttbarfakes}. The
multi-jet background is estimated using a fully data-driven \emph{fake factor
  method} that is introduced in \Cref{sec:bkg_hadhad_ff}. Both methods were
...
\faketauhadvis backgrounds from multi-jet and \ttbar processes. This method is
briefly summarised in~\Cref{sec:bkg_lephad_combined_ff}.
