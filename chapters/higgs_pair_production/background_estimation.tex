...
\todo[inline]{Should mention the floating backgrounds (\ttbar, \ZHF).}
...
\todo[inline]{Maybe say something about tau fakes being a rather small
  very non-signal like background thus not being super sensitive to
  large uncertainties on it.}
