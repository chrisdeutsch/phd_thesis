...
The \ZHF control region is included in the simultaneous likelihood fit of signal
and control regions to provide constraints on the normalisation of the \ZHF
...
control region yields estimates of the normalisation factors of \num{1.39 \pm
  0.12} and \num{0.97 \pm 0.04} for \ZHF and \ttbar, respectively. The quoted
normalisation factors include all statistical and systematic
