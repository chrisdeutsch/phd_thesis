...
\Cref{sec:data_and_simulation}). Hard-scatter matrix elements are
...
\begin{table}[htbp]
  ...
  \begin{subtable}{0.5\textwidth}
    ...
    \input{tables/zcr_postfit_yields}
  \end{subtable}
\end{table}
...
in~\Cref{sec:uncertainties,sec:statistical_analysis}. When performing
...
and \mll distribution is shown in~\Cref{tab:zcr_postfit_yields}
