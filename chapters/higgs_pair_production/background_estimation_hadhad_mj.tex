...
% general ABCD method.}
Generally, the CRs do not provide pure samples of multi-jet event, and thus the
...
region~$r$ estimated using simulation.
...
candidate properties.\todo{Move this paragraph to a later part?}
