...
equally once \pT-threshold effects are accounted for. % This is not the case for
...
according to~\Cref{eq:inclusive_fake_factor} and parameterised in \tauhadvis
...
in~\Cref{fig:mjfakes_stt_ffs} for the three major data collection periods. Each
...
in~\Cref{fig:fake_factor_OSSS} for di-\tauhadvis and single-\tauhadvis
triggers. A comparison of the all sets di-\tauhadvis trigger FFs using
$\chi^2$-tests is given in~\Cref{tab:fake_factor_osss_chi2test} showing good
