...
\begin{table}[htbp]
  ...
  \caption{Impact of uncertainties on the normalisation of the multi-jet
    ...
    statistical uncertainties from the finite number of simulated and control
    region events are combined for all background processes thus no dedicated
    nuisance parameters exist for the statistical uncertainty of the multi-jet
    prediction.}%
