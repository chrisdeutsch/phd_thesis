...
the other \PW boson decaying hadronically, producing jets that mimick
...
non-disjoint sub-regions of the SF-CR are defined for cases where
...
leaving the \ttbar normalisation free in every sub-region separately
...
\tauhadvis are required to fail the loose working point but having an
...
The scale factors measured in the Anti-ID region are shown in. The
efficiency of selecting a quark- or gluon-jet as an \antitau are well
predicted in simulation of \ttbar.
