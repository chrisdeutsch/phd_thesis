...
dissimilar to the multi-jet background discussed
...
\todo[inline]{Should already say that this is extracted in a
  likelihood fit.}
...
di-leptonic \ttbar.  The fractional contribution of \ttbar with
\tauhadvis originating from quark or gluon jets is
\SI{28}{\percent}. Minor backgrounds in this region are single top
...
states in the top control region is shown
in~\Cref{fig:ttbarsf_mtw_pdf}.
% inclusive in reconstructed \tauhadvis decay mode and transverse momentum.
The primary source of events containing a \faketauhadvis in the top
control region is semi-leptonic \ttbar with an electron or muon and
jets. This contribution features a quick reduction in event rate for
transverse masses beyond the mass of the \PW boson. In contrast,
di-leptonic \ttbar shows a comparatively heavy tail towards large
values of \mTW due to the presence of an additional neutrino.  The
\mTW distribution of semi-leptonic \ttbar remains stable with respect
to changes in the considered momentum range for the reconstructed
...
\mTW to distinguish between \ttbar with \faketauhadvis and with real
...
separately. The (fiducial?)  \ttbar cross section is extracted from
the fit to data. This is accomplished by allowing the normalisation of
\ttbar with and without \faketauhadvis to vary freely. The associated
...
\ttbar cross section free in every measurement region separately due
to the weak discrimination power of \mTW for small \tauhadvis \pT.
...
\ttbar with true and fake-\tauhadvis.

Additional uncertainties are discussed later?
