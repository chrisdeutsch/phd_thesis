...
in the same direction with respect to the nominal scale
factors.
...
The sets of scale factors are chosen depending on the trigger category
and whether the leading, subleading, or both \tauhadvis are
originating from jet. Strategy is outlined
in~\Cref{tab:ttbarSF_application_rule}.

% STT: (note the simplification)
% Leading fake tau: HLT_tau25
% Subleading fake tau: OFFL
% Both fake tau: HLT_tau25 & OFFL

% DTT:
% Leading fake tau: HLT_tau25
% Subleading fake tau: HLT_tau25
% Both fake tau: HLT_tau25^2
