...
\faketauhadvis SFs. Generally, both predictions agree within uncertainties
except for the FT~component. The predicted number of FT~events is smaller after
application of \ttbarFake SFs due to SFs being smaller than unity for
\faketauhadvis with high~\pT.
