...
candidate \Ntracks and \pT and targeting \ttbar events, constraints on the
...
and without \faketauhadvis leads to large anti-correlations of the
\faketauhadvis SFs and the overall \ttbar normalisation factor. This is
illustrated in the correlation matrix depicted in \Cref{fig:ttbarSF_corr_matrix}
for an exemplary SF measurement. In addition, the anti-correlation between SFs
and the overall \ttbar normalisation factor also induces a correlation between
SFs themselves, leading to positive correlation coefficients between SFs of
different \tauhadvis \Ntracks and \pT bins.
