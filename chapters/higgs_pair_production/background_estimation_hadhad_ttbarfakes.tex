...
\subsubsection{Estimation of \Faketauhadvis Scale Factors for the \antiid
  Region}
...
HLT are imposed.\todo{Already explained (object selection)}
...
\todo[inline]{Plots here or appendix: \ttbarFakes estimate in the \hadhad SR
  (taupt?). taupt in the \antiid SF-CR before and after trigger matching?}
