...
% \end{align*}
The relative uncertainties on the prediction of the \ttbarFakes background in
the SR of the \hadhad channel are summarised in the following:
\begin{itemize}

\item Uncertainties of the SF measurement: $\pm \SI{8.5}{\percent}$

\item Extrapolation uncertainties: $\pm \SI{9.7}{\percent}$

\item Trigger \pT / \ET thresholds: $\pm \SI{0.2}{\percent}$

\item MC statistical uncertainty: $\pm \SI{0.9}{\percent}$

\end{itemize}
Moreover, the predicted \ttbarFakes event yields in the \hadhad channel are
summarised in \Cref{tab:ttbarSF_yields} and compared to the \ttbar simulation
without application of the \faketauhadvis~SFs.
...
\begin{table}[htbp]
  ...
  \caption{Expected number of \ttbarFakes events in the SR of the \hadhad
    ...
    estimate using the \faketauhadvis~SFs include all statistical and systematic
    uncertainties.}%
