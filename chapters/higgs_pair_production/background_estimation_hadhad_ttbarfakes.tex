...
\faketauhadvis SFs and the \ttbar normalisation factor. Due to this coupling, a
positive correlation is induced between the SFs themselves. This is illustrated
in the correlation matrix depicted in \Cref{fig:ttbarSF_corr_matrix} for an
exemplary SF measurement.
