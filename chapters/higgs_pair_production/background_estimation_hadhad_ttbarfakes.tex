...
factor measurement is performed in bins/categories of \Ntracks and \pT of the
...
25 to \SI{30}{\GeV} are omitted due to the \tauhadvis-triggers not being fully
efficient in this region. This is analogous to the selections applied in the
signal region of the \hadhad channel. Examples of the event yields in the
categories are shown in~\Cref{fig:ttbarsf_region_summary_prefit}.\todo{Remove
...
\begin{figure}[htbp]
  ...
  \caption{Transverse mass distribution of the lepton and \pTmiss in simulated
    ...
    \tauhadvis candidate \pT and \Ntracks.}%
...
every \tauhadvis candidate \pT and \Ntracks category, an unconstrained scale
factor is introduced that changes the normalisation of the \ttbarFakes
background in this category. These \faketauhadvis scale factors are considered
the parameters of interest of the measurement.
...
\begin{figure}[htbp]
  ...
  \caption{Histograms of the \mTW distributions in two exemplary \tauhadvis
    candidate \Ntracks and \pT categories. Two exemplary \mTW distributions as
...
\subsubsection{Uncertainties of the Scale Factor Measurement}
