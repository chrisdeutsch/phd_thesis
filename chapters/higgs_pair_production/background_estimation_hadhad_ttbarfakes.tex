...
multi-jet events (to be discussed in~\Cref{sec:hadhad_multijet})
...
\item In the \hadhad channel, no suitable \ttbarFakes control region
  ...
  a \ttbar control region in the \lephad channel where the multi-jet
  contribution is negligible.
\end{itemize}

The \ttbarFakes background is estimated using simulation after
including data-driven corrections measured in a \ttbar control
...
using a maximum likelihood fit in the control region.  In the \hadhad
signal region, the measured scale factors are applied to simulated
\ttbarFakes events to obtain the background prediction and the
