...
For \faketauhadis reconstructed as 1-prong \tauhadvis candidates,
...
Fit cross checks (i.e.\ pulls, constraints). Ranking plot?
...
in~\Cref{fig:ttbarSF_corr_matrix}. \todo{Why: Change in the global
  \ttbar normalisation affecting \ttbar with true and fake taus, can
  be compensated (at least partially) by an opposite sign change in
  the SF in all bins. This is possible to some extent due to
  relatively weak discrimination power especially in a low momentum
  regime.} This coupling also introduces large positive correlations
...
in~\Cref{fig:ttbarSF_eigenvariations}.\todo{Interpretation of this
  plot?}
