...
Ref.~\cite{HDBS-2018-40} and is not discussed in this thesis.
...
\begin{figure}[htbp]
  ...
  \caption[Resolution and bias of the $H$- and $HH$-system invariant mass
  reconstruction in the \hadhad SR.]{Performance of methods used to reconstruct
    the \PHiggs-system (a) and the \HH-system (b) invariant mass in the \hadhad
    signal region estimated using simulation of $\PX \ra \HH \ra \bbtautau$
