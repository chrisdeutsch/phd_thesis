...
are reconstructed (cf.~\Cref{sec:hbb_reco,sec:htautau_reco}) and are
...
The MMC, introduced in~\Cref{sec:htautau_reco}, is used to reconstruct
...
\begin{figure}[htbp]
  ...
  \todo[inline]{Should say sth.\ about the bias and behaviour.}
