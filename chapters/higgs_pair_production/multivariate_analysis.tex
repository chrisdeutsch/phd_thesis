...
Higgs bosons originating from SM~\HH or resonant \HH production (with
...
tends to be small. The angular distances \dRtautau and \dRbb between the visible
decay products of the \taulepotons ($e$, $\mu$, \tauhadvis) and the $b$-jet
candidates, respectively, are reconstructed. These variables provide
discrimination power against backgrounds from multi-jet and top-quark pair
production in which the \taulepton and $b$-jet candidates are less collimated.
Both variables are used as inputs to the classifiers in the \hadhad and \lephad
SLT channel.
