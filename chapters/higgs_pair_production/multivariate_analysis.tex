...
search for resonant \HH production, multiple mass hypotheses for the scalar
...
(PNNs), which were first introduced to HEP in Ref.~\cite{Baldi:2016fzo}.
...
% parameters;
PNNs are used as discriminants in the search for resonant \HH production in the
\hadhad and \lephad channels.
