...
The event selection described in~\Cref{sec:event_selection} serves to select
events compatible with $\bbbar\hadhad$ or $\bbbar\lephad$ final states and
ensures that reconstructed objects fulfil basic requirements. The
...
% , which were first introduced to HEP in Ref..
