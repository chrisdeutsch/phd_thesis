...
previously shown in~\Cref{fig:pnn_detuning}, exhibits peaks of a width
...
(cf.~\Cref{fig:pnn_properties}) can be used to estimate the
sensitivity of the signal extraction method to the mass of the scalar
resonance.

This is shown in~\Cref{tab:pnn_width}


Reasonable 'resolution' at low mass but degrading towards higher
...
% Getting asymmetric at very high masses.
