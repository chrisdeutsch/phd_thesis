...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[t]{.48\textwidth}
    \includegraphics[width=\textwidth]{mva/prefit/Region_BMin0_incJet1_distmHH_J2_Y2015_DLLOS_T2_SpcTauHH_L0_Prefitlog}
  \end{subfigure}
  ...
  \todo[inline]{Missing signal... Restrict mtt mbb range to 500 GeV}
...
class probabilities\todo{not true}.
