...
(cf.\todo{backref}) and can be used to estimate properties of the SM
...
after $b$-jet momentum correction (cf.~\todo{backref}). In this case,
...
\mHH very sensitive for resonant production modes at high \mX.
...
are shown in~\Cref{sec:}. A selection of important input variables in
