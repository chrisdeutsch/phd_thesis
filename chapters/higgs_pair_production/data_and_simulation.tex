...
using a $\pp \to \HH$ cross section of \SI{31.05}{\femto\barn} at
...
variations and the treatment of the finite top-quark mass\footnote{This
  uncertainty is defined by a comparison of the pole mass and the
  $\overline{\text{MS}}$ scheme for the mass of virtual
  top-quarks.}~\cite{Baglio:2020wgt} and $\pm\SI{3}{\percent}$ from
uncertainties on PDFs and $\alphas$~\cite{LHCHWGHH}.
