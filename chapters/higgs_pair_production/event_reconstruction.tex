...
Only applied to $b$-tagged jets.

Muon-in-jet correction: Accounting for small calorimeter energy
...
\begin{figure}[htbp]
  ...
  \caption{Impact of $b$-jet momentum corrections on the reconstructed
    \mBB. On reconstructed Higgs boson candidates in \ggF SM \HH. A
    fit of a Bukin function is performed \cite{Bukin:2007zha} and the
    peak position and width of the Gaussian core is given.}
