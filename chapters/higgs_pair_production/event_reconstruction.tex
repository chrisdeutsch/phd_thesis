...
\item[Muons] are required to have $\pT > \SI{7}{\GeV}$ and pass the
  ...
  Muons are required to be isolated ...  Similar to the electron
  isolation requirement, the muon isolation is inverted as part of the
  \faketauhadvis background estimation in the \lephad channel to
  provide a multi-jet control region.
