...
\item[Jets] are reconstructed using the anti-\kt
  ...
  clusters in the calorimeters only~\cite{PERF-2015-09,JETM-2018-05}.
  ...
  Jets originating from pile-up are suppressed by ensuring that jets
  pass jet-vertex-tagger (JVT) requirements. Jets in the central
  region are required to pass the tight working point of the
  JVT~\cite{PERF-2014-03}. Jets in the forward region, which lack
  tracking system coverage, are requried to fulfill the loose working
  point of a dedicated jet-vertex-tagger for forward
  jets~\cite{PERF-2016-06-witherratum,ATL-PHYS-PUB-2019-026}.

  A multivariate $b$-tagging algorithm,
  DL1r~\cite{FTAG-2018-01,ATL-PHYS-PUB-2017-013}, with
  \SI{77}{\percent} efficiency in \ttbar.
