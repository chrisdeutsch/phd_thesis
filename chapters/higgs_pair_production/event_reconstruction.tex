...
two \tauhadvis candidates, while in \lephad the visible decay products
are one \tauhadvis candidate and either an electron or a muon. To
obtain the four-momentum of the $H \to \tau^{+}\tau^{-}$ candidate,
including the four-momenta of visible and invisible particles,
additional information on the neutrinos produced from the \taulepton
decay is needed. Possible configurations of the \taulepton decays can
be limited by exploiting constraints originating from the known mass
of the \taulepton and from the measured \pTmiss under the assumption
that it soley originates from neutrinos produced in decays of
\tauleptons. However, even with these constraints the system is
underdetermined requiring a probabilistic description of the remaining
degrees of freedom.
