...
\taulepton and the measururement of \pTmiss under the assumption that
...
being parametrised as a function of the event activity\footnote{The
  event activitiy, also referred to as $\sum \ET$, is the scalar sum
