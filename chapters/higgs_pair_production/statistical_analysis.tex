...
signal-like bins is close to \SI{50}{\percent}.\todo{Point out the
  large uncertainty on \ZHF and single Higgs?}
...
quark backgrounds are more abundant\footnote{The targeted
  $\ell + \tauhad$ final state in the \lephad channel does not
  distinguish between prompt production of electrons and muons and
  non-prompt production via leptonic \taulepton decays.}  with a large
