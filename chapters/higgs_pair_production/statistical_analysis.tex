...
\begin{figure}[htbp]
  ...
  \caption{Distribution of the PNN discriminant in the \hadhad channel after the
    ...
    distributions are shown for four different parameter values of the
...
\begin{table}[htbp]
  ...
  \caption{Expected number of events per physics process in the \hadhad SR for
    ...
    shown for $\mX = \SI{300}{\GeV}$ and \SI{500}{\GeV}. $\dagger$:~The large
...
level of $\num{3.0}\,\sigma$.
% \footnote{By convention in HEP the discovery
...
\begin{figure}[htbp]
  ...
  \caption{Expected local $p$-values from hypothesis tests performed on Asimov
    datasets with injected signals with \mX of \num{900}, \num{1000}, and
    \SI{1100}{\GeV}. The injected signals are normalised to their best-fit
    signal strength from the unconditional fit to observed data in all channels.
    Signals are injected in all SRs and the expected $p$-value resulting from
    the statistical interpretation of the combination of all channels is
    shown. The observed $p$-values (dashed line) are included for comparison.}
