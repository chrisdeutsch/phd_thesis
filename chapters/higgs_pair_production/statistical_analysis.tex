...
\item The most background-like bins (bins numbered 1) feature a large
  ...
  boson pairs. An example are events where both \mMMC and \mBB are far
  from the mass of the Higgs boson.
...
to separate the signatures of signal-like events at high \mX,
partially due to the degradation in the absolute resolution of the
\mHH reconstruction. This is reflected in the correlation coefficient
of the observables for the most signal-like bins of adjacent mass
points reaching values of up to \SI{75}{\percent}. The correlation
