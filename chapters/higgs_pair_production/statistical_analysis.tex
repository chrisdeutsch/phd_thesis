...
is made because signed significances are marginally distributed
following the Standard Normal distribution under the background-only
hypothesis, lending itself for easier interpretation.


In \Cref{fig:corr_sig} the matrix of
linear correlation coefficients of the test statistics is shown,
determined using the toy experiments.

thus providing an illustration of
the dependencies between all hypothesis tests.
