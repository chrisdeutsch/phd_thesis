...
Probability to have one or more false discoveries (type II errors)
over the set (family of 20) of considered hypothesis tests given some
threshold. This will lead to the definition of the global significance
when the maximum observed is considered as the threshold. (FWER?)
...
generative model used to define the likelihood function cannot be used
