...
\item[Global observables (Barlow--Beeston method)] The global observables
  ...
  simulation and CR data used for background estimation. For every bin, the
  effective number of unweighted events is recalculated using the resampled
  datasets. The resulting values of the global observables are then used as a
  toy experiment for the global significance estimation.
