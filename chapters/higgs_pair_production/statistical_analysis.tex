...
individual nuisance parameters in~\Cref{fig:nonres_np_rankings}. The
figure shows a ranking of the 15 nuisance parameters with the largest
impact on the signal strength estimation and their MLE, including
\SI{68}{\percent} confidence intervals, from the fit of the
signal-plus-background model to observed data.
