...
The search for resonant production of Higgs boson pairs via scalar
resonances is primarily limited by the statistical uncertainty of the
observed data. This is illustrated in~\Cref{tab:breakdown_res} where
the variance on the best-fit cross section is decomposed into
categories of uncertainties for four exemplary signal mass hypotheses.
