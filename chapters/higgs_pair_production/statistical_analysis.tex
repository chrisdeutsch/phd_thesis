...
For this interpretation the absence of SM Higgs boson pair production
is assumed.
...
\begin{figure}[htbp]
  ...
  \caption{Distribution of the PNN discriminant of the \hadhad channel
    after the maximum likelihood fit of the background-only model.}%
  \label{fig:resonant_mva_postfit}

  \todo[inline]{Put lephad equivalents in appendix?}
\end{figure}
