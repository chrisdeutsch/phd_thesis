...
acceptance uncertainty based on the parton shower comparison primarily
originates from the \lephad SLT channel which has high purity of top
quark backgrounds. Since the constraint is rather large, this
uncertainty source is de-correlated between channels to avoid
underestimating the acceptance uncertainty in other channels based on
the constraints meausred in the \lephad SLT channel\todo{Should
