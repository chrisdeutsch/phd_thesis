...
the NPs and their \SI{68}{\percent} confidence intervals. Generally, the 15
highest ranked NPs are compatible with their pre-fit values. For few NPs the fit
provides more stringent constraints than suggested by their prior measurement,
which is consistent with results from fits to Asimov dataset.
