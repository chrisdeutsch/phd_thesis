...
summarised in~\Cref{tab:limits_non_resonant}, separately for the \lephad
channels, the \hadhad channel, and their combination.
...
\begin{table}[htbp]
  ...
  \caption{Expected and observed upper limits on the the cross section of SM~\HH
    ...
    hypothesis. Uncertainties on the SM prediction of \xsecggfvbf are not
    considered when setting limits on the cross section directly. The table is
    adapted from Ref~\cite{HDBS-2018-40}.}%
...
(\num{4.4}). Further discussion and interpretation of these results is given
