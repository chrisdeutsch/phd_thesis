...
Systematic uncertainties have a considerable effect on the total
variance of $\hat{\sigma}$ at low mass. For $\mX = \SI{300}{\GeV}$ the
effect of systematic uncertainties explains \SI{42}{\percent} of the
total variance on $\hat{\sigma}$. Instrumental uncertainties from
jets, \pTmissAbs, and \tauhadvis have a sizable effect only at low \mX
(low momenta of the objects).
