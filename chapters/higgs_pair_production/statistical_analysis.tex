...
\Cref{sec:statistical_inference}. The main results of the statistical
...
MLE of the model parameters, the errors on the estimated parameters, and their
correlations were inspected to ensure that the model behaves as expected. During
...
% \todo[inline]{Maybe a short introductory sentence to say that details of the
% fit model are discussed hereafter. Also could briefly mention that we omit
