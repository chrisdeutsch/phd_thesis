...
\begin{sidewaysfigure}[p]
  ...
  \hadhad SR and \ZHF~CR, and the \lephad SRs and \ZHF~CR.]{Ranking of NPs based
    ...
    signal strength~$\Delta \mu$ when performing the fit after fixing a given NP
    ...
    the mean~$|\Delta \mu|$. The bottom axis shows the MLE of the NPs and the
...
\begin{table}[htbp]
  ...
  for the search for resonant \HH production.]{Breakdown of the variance of
    ...
    decomposition is determined analogously to~\Cref{tab:breakdown_nonres}. A
    similar breakdown based on fits to Asimov data is given in
