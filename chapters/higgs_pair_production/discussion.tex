...
the most sensitive channels~(cf.~\Cref{fig:run2_hh_results}), yielding observed
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.6\textwidth]{discussion/atlas_comparison_resonant}
...
% \lephad channels, for which the CR measurement of the \ZHF
