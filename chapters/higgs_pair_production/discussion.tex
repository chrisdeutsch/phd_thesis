...
best-fit cross section of \SIpmerr{17.4}{+7.5}{-6.5}{\femto\barn} is compared to
results of other searches. The ATLAS search in the \bbbb channel yields an
observed (expected) upper limit of \SI{6.5}{\femto\barn} (\SI{8.1}{\femto\barn})
on $\sigma(\pp \to X \to \HH)$ at
$\mX = \SI{1000}{\GeV}$~\cite{HDBS-2018-41,hepdata.111124}. Therefore, the
best-fit cross section of the excess observed in the \bbtautau channel is
already excluded at \SI{95}{\percent} by the search in the \bbbb final
state. Furthermore, searches by the CMS collaboration
