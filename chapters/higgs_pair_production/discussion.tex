...
% Or by further relaxing the selection requirements yielding larger signal
% acceptance. Although this would also increase the background and thus might
% not correspond to a net improvement of the results.
...
\begin{figure}[tbp]
  ...
  \begin{subfigure}[b]{0.65\textwidth}
    \hspace{1.05em}\includegraphics[width=0.9\textwidth]{discussion/results_139ifb}

    \subcaption{Full Run~2 dataset with an integrated luminosity
      of~\SI{139}{\per\femto\barn}~\cite{HDBS-2022-03}.}%
  ...
  \begin{subfigure}[b]{0.65\textwidth}
    \includegraphics[width=0.94\textwidth]{discussion/cms_results_run2}

    \subcaption{CMS~\cite{CMS-HIG-22-001}.}
  \end{subfigure}
