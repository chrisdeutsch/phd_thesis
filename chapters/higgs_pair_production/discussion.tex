...
sensitive searches for SM~\HH production by the ATLAS and CMS collaborations.





This result is put into context by summarising past and present results of
direct SM \HH searches by the ATLAS collaboration
in~\Cref{fig:atlas_run2_hh_results} and with the results of the CMS
collaboration in~\Cref{tab:cms_nonresonant} for analyses of the Run~2 dataset of
$pp$-collisions.

% The upper limits on the SM~\HH signal strength in the most sensitive search
% channels are summarised in~\Cref{fig:run2_hh_results}.
