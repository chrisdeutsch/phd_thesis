...
channel. This is shown in \Cref{fig:run2_hh_results}, which compares the upper
...
channels~(cf.~\Cref{fig:run2_hh_results}), yielding observed (expected) upper
...
With\todo{better transition} the full Run~2 dataset, an expected upper limit of
...
The analysis of the full Run~2 $pp$-collision dataset presented in this work
