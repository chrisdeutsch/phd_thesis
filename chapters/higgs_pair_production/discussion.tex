...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.65\textwidth]{discussion/atlas_comparison_boosted}
...
\begin{figure}[htbp]
  ...
  % \caption{Expected and observed upper limits on $\sigma(X \to \HH)$ for
  % narrow width scalar resonances $X$ at \SI{95}{\percent}~CL. Upper limits are
