This chapter presents a search for Higgs boson pair production in \bbtautau
...
\SI{7.3}{\percent} (cf.~\Cref{fig:hh_branching_ratios}) and the distinct
...
\Cref{sec:higgs_self_coupling}. The search for resonant production of Higgs
