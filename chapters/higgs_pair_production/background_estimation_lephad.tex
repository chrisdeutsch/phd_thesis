The estimation of \faketauhadvisC backgrounds in the \lephad channels is outlined
...
When estimating the \faketauhadvisC background in one of the \lephad SRs, it
...
\SIrange[range-units=single]{10}{30}{\percent} depending on \tauhadvis candidate \pT and
...
% The \faketauhadvisC estimation in the \lephad channel is concluded by briefly
...
% preferred compared to performing separate estimates of the \faketauhadvisC
...
% resulting \faketauhadvisC background estimate.
...
% search is not limited by uncertainties related to the \faketauhadvisC
