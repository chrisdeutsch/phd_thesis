...
explain how elementary particles acquire mass.
...
lends confidence in the SM, further tests are required to ensure agreement with
the physics realised in nature.
...
In particular, the work presented in this thesis is concerned with testing the
BEH mechanism in the SM.


This thesis
- Investigate BEH mechanism
- Higgs boson self-coupling
- Motivation: As a check of the SM, and as a possible probe for new physics.

- ATLAS Experiment
- HH -> bbtautau with a focus on hadhad
-
