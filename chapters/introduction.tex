...
SM as it induces the process of EWSB that is instrumental to generate the masses
of elementary particles. Direct measurements of the Higgs boson self-coupling
are therefore of interest to further test our understanding of EWSB in the SM.
...
This thesis is concerned with searches for Higgs boson pair production in final
states with a pair of $b$-quarks and a pair of \tauleptons
($HH \to \bbbar\tau^+\tau^-$). These searches are performed using proton--proton
collision data at a centre-of-mass energy of \SI{13}{\TeV} recorded by the ATLAS
detector during Run~2 of the LHC. The data were collected over a period spanning
from 2015 to 2018 by the ATLAS collaboration yielding a dataset with an
integrated luminosity of \SI{139}{\per\femto\barn}.
...
- Investigate BEH mechanism: Nature of the BEH potential (which induces electroweak symmetry breaking)

- Higgs boson self-coupling
- Motivation: As a check of the SM, and as a possible probe for new physics.
