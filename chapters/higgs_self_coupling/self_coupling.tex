...
\Cref{fig:dihiggs_vbf_feyn}) and resulting in a different
...
function of \klambda. %These upper limits allow,
...
\Cref{sec:statistical_analysis} with a few modifications. These
...
\begin{figure}[htbp]
  ...
  % The theory prediction previously described in \Cref{fig:hh_xsec_incl} is
  % overlaid.
...
\Cref{tab:cms_klambda} showing similar findings to those of the ATLAS
collaboration.
