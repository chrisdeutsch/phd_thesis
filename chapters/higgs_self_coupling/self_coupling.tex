...
% This sensitivity is due to the \klambda
...
is disussed in \Cref{sec:reinterpretation}. The upper limits on the
...
\Cref{fig:acceptance_vs_klambda}, showing the largest \AccTimesEff for
...
illustrated in \Cref{fig:acceptance_vs_mhh} exemplary for the dominant
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[t]{0.485\textwidth}
    ...
    \subcaption{\AccTimesEff of signal events produced via \ggF and
      VBF as a function of \klambda. The combination of all channels
      is shown in black.}%
    \label{fig:acceptance_vs_klambda}
  \end{subfigure}\hfill%
  \begin{subfigure}[t]{0.485\textwidth}
    \includegraphics[width=\textwidth]{self_coupling/acc_vs_mhh}
    \subcaption{\AccTimesEff of signal events produced via \ggF in
      bins of generator-level \mHH.}%
