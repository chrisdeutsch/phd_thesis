...
using the cross section~$\sigma_{\text{ggF+VBF}}$ which is considered
the parameter of interest and is allowed to vary freely in the
model.\footnote{The total cross section $\sigma_{\text{ggF+VBF}}$ is
  ...
  branching ratios as predicted by the SM.}  The methods for obtaining
signal templates in the signal regions is described in
