...
%   \caption{Summary of allowed \klambda intervals obtained from searches for
%     non-resonant \HH production by the CMS collaboration using
%     \SI{138}{\per\femto\barn} of \pp-collision data taken during Run~2 of the
%     LHC. $\dagger$: The search in the \bbyy channel accounts for the change in
%     single Higgs boson production cross section and branching ratio with
%     \klambda.}%
%   \label{tab:cms_klambda}
% \end{table}
