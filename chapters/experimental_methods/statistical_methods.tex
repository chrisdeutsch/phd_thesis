...
With the statistical model introduced previously, a null hypothesis, $H_0$, can be defined as
\begin{align*}
  H_0: (\mu, \myvec{\theta}) \in \Omega_0
  \quad \text{with} \quad \Omega_0 \subset \Omega \,\text{,}
\end{align*}
where $\Omega_0$ is the set of model parameters specifying the null
hypothesis,\footnote{Example: Taking the background-only hypothesis as the null
  ...
  = 0 \}$.}  and an alternative hypothesis, $H_1$, defined as
\begin{align*}
