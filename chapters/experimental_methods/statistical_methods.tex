...
following. Among these are methods for parameter estimation and statistical
hypothesis testing. They are used to fit statistical models to observed data (or
...
discriminating variable. Events from different signal and background processes
contribute to these regions. These processes are referred to as \emph{physics
  processes} hereafter. \textsc{HistFactory}~\cite{cranmer2012}
...
In this thesis, statistical software based on
\textsc{HistFactory}~\cite{cranmer2012}, \textsc{RooFit}~\cite{Verkerke:2003ir},
and \textsc{RooStats}~\cite{Moneta:2010pm} is used to construct statistical
models and to perform the statistical interpretation of results. The
\textsc{HistFactory} model forms the foundation of the statistical
interpretation and thus is introduced in the following. The notation of
Ref.~\cite{cranmer2012} is adopted with few modifications.
