...
rate~\cite{Goodfellow-et-al-2016}. The learning rate can follow a pre-defined
...
specialised network architectures. Among these architectures are \emph{recurrent
  neural networks} (RNN), which allow to operate on variable-length
...
jets reconstructed in an particle collision event as a variable-length sequence.
