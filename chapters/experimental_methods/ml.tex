...
collectively referred to as \emph{decision trees}, are used as weak learners in
...
that the prediction of a decision tree can be written as~\cite{hastie09}
\begin{align*}
...
onode in a regression tree is chosen such that the squared error defined as
\begin{align*}
