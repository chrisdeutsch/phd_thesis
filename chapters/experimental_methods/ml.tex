...
growing algorithm, the split (and the corresponding leaf node constants) leading
to the largest reduction in MSE is chosen. The tree growing algorithm terminates
once no further splits can be performed.
