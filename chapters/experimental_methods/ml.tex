...
with inputs~$\myvec{x}$ and free
parameters~$\myvec{\theta}$.\footnote{Application of the logistic (sigmoid)
  function as the activation function in the final layer constrains NN outputs
  to be within $(0, 1)$.} In this case, the canonical loss function for binary
classification is
\begin{align}
