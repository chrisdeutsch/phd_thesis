...
\begin{figure}[htbp]
  ...
  \caption[A decision tree partitioning a two-dimensional space.]{A decision
    tree partitioning a two-dimensional space with coordinates~$(x_1, x_2)$. The
    tree has a depth of two and four leaf nodes that define the
    regions~$R_1, \dots, R_4$. The figure is adapted from
    Ref.~\cite{hastie09}.}%
