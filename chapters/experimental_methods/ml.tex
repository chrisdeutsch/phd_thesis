...
In the field of HEP, one is often concerned with the analysis of experimental
data with observations consisting of numerous observed quantities.
% The analysis of such data is referred to as multivariate analysis (MVA).
A common tasks in HEP is classificiation, an example being the classification of
particle collision events into events from signal and background processes. In
the past, classification rules were often determined by hand. This is a
difficult and time intensive process, in particular when working with
high-dimensional data. Over the last decade, the use of machine learning methods
in HEP has become increasingly popular as an alternative approach.
...
During the last, the use of machine learning methods in HEP has become
...
The use of machine learning is becoming increasingly prevalent
