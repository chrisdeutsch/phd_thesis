...
to the positive class~\cite{Friedman:2000}. Knowledge of $F^{*\!}$ would solve
the classification task since
\begin{align}
...
\end{enumerate}
\vspace{6pt} This algorithm is reminiscent of the classical gradient descent
