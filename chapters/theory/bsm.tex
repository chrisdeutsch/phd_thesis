...
\item[The electroweak hierarchy problem] The mass of the Higgs boson is affected
  ...
  considered that the SM remains valid up to a larger energy scale, for example
  the scale of a \emph{Grand Unified Theory} (GUT) of about
  ...
  the theory parameters, otherwise radiative corrections will drag the Higgs
