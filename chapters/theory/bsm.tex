...
particles as indicated in \Cref{fig:bsm_hh_prod_feyn}. If the mass scale of the
...
state particles. These effects will be discussed more concretely in
...
searches constitute a major part of \Cref{sec:dihiggs,sec:higgs_self_coupling},
...
\end{description}
These examples serve as an illustration in how an extended Higgs sector can lead
to the resonant production of Higgs boson pairs. In this thesis, the decay of a
CP-even scalar produced via \ggF in a 2HDM model (cf.\
\Cref{fig:resonant_production_feyn}) is used as a benchmark signal. The decay
width of the scalar is assumed to be significantly narrower than the
experimental mass resolution such that interference with SM \HH production
becomes negligible.
