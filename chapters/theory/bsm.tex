...
\item[Matter-antimatter asymmetry] In the Big Bang cosmological model, equal
  ...
  exist~\cite{T2K:2019bcf}, it is unclear if its size is sufficient to explain
...
\item[The electroweak hierarchy problem] The mass of the Higgs boson is affected
  ...
  electroweak scale of $\mathcal{O}(\SI{100}{\GeV})$, implying that the SM
  cannot remain valid beyond a scale of $\mathcal{O}(\SI{1}{\TeV})$, at which
  ...
  will drag the Higgs boson mass towards, for example, the GUT scale.
