...
\item[Dark matter and dark energy] Astrophysical
  observations~\cite{Zwicky:1933gu,Zwicky:1937zza,Rubin:1970zza,Rubin:1980zd,Clowe:2006eq}
  indicate that the majority of the matter content of the universe consists of
  \emph{dark matter}, a form of matter that does not participate in the
  electromagnetic interaction. Its existence can, however, be inferred from the
  ...
  matter candidate that is consistent with current cosmological
  models. Moreover, the observation of an accelerated expansion of the
  universe~\cite{SupernovaSearchTeam:1998fmf,SupernovaCosmologyProject:1998vns}
  is hypothesised to originate from a form of energy referred to as \emph{dark
    energy}. This energy is associated with the vacuum of space and its origin
  remains unexplained in the framework of the SM.
...
\item[Neutrino masses] The observation of neutrino
  ...
  are unnaturally small compared to the mass scales of other fermions
...
SM value of $\lambdahhh^\text{SM} = 3 m_{H}^2 / \varv$. Such deviations can
...
coupling constant
\begin{align*}
  \lambdahhh = \klambda \times \lambdahhh^{\text{SM}} \,\text{,}
\end{align*}
...
\item[Additional Higgs-singlet models] The simplest extension of the SM Higgs
  ...
  therefore be part of a ``hidden sector'' that might provide a suitable
  ...
  \end{align*}
  where $\phi$ refers to the complex Higgs-doublet and $V(\phi)$ is the Higgs
  ...
  % \footnote{The bilinear terms only appear if either $a_1 \neq 0$, or
  % $a_2 \neq 0$ and $\phi_{S}$ has non-vanishing VEV. See for example
  % Ref.~\cite{Chen:2014ask}.}
...
(cf.~\Cref{fig:resonant_production_feyn}).
% The width of the resonance is assumed to be narrow such that interference with
% SM \HH production can be neglected.
