...
Anomalous coupling $\lambda_{HHH}$ expressed as a coupling modifier
$\klambda = \lambda_{HHH} / \lambda_{HHH}^{\text{SM}}$.

Also BSM theories that predict different $\lambda_{HHH}$???
