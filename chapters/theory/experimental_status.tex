...
\begin{figure}[htbp]
  ...
  \caption{Upper limits on the cross-section of non-resonant \HH production at
    \SI{95}{\percent} CL as a function of \klambda by the ATLAS (a) and CMS (b)
    collaborations. The expected upper limits are obtained under the
...
considered by both collaboration. The upper limits at \SI{95}{\percent} CL on
the production cross-section of the scalar resonance as a function of its mass
is shown in \Cref{fig:prior_status_reso}. Neither the ATLAS nor the CMS result
show a statistically significant excess in the search for resonant \HH
production. The excluded cross-sections range spans from about
\SI{1000}{\femto\barn} at low mass to about \SI{5}{\femto\barn} at high
resonance mass.
...
\begin{figure}[htbp]
  ...
  \caption{Upper limits at \SI{95}{\percent} CL on the production cross-section
    of CP-even, scalar resonance ($S$ / $X$) decaying into a pair of SM Higgs
    bosons by the ATLAS (a) and CMS (b) collaboration.  The results are based on
