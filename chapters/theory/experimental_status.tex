...
\begin{figure}[htbp]
  ...
  \caption[Upper limits on the resonant \HH production cross section by the
  ATLAS and CMS collaborations based on \pp~collision data taken in 2015 and
  2016.]{Upper limits at \SI{95}{\percent} CL on the production cross section of
    CP-even, scalar resonances ($S$ / $X$) decaying into a pair of SM Higgs
    ...
    on \pp~collision data taken in 2015 and 2016.}%
