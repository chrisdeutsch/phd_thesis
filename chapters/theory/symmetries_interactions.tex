...
\begin{align*}
  &m_W = \frac{1}{2} g \varv  &&m_Z = \frac{1}{2} \sqrt{g^2 + {g^\prime}^2} \, \varv && m_A = 0 \,\text{.}
\end{align*}
...
\begin{figure}[htbp]
  ...
  \caption[Interaction vertices of Higgs bosons coupling to other SM
  bosons.]{Interaction vertices of Higgs bosons coupling to other bosons
    predicted by the SM.}%
