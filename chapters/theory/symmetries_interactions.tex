...
possesses global gauge invariance with respect to $U(1)$ transformations given
by $\psi \to \psi^\prime = \exp[ i q \theta ] \psi$, where $q$ is an arbitrary
...
charge which comes in three distinct colours referred to as red, green, and blue
...
\end{align*}
where $G_{\mu\nu}^i$ is the gluon field strength tensor defined as
\begin{align*}
...
leads to this behaviour. This is unlike the photon of QED which is not a carrier
of electrical charge and thus does not couple to itself.
...
the interaction are massive with masses of~\cite{pdg2020}
\begin{align*}
...
Given this grouping of fermions, transformations from the $SU(2)_{\text{L}}$
group only affect fermions with left-handed chirality, thus motivating the
choice of subscript.
...
\end{align*}
where $f_{ijk}$ are the structure constants of the $SU(2)_{\text{L}}$ group.

Substituting the gauge covariant derivative into the kinetic term of the Dirac
Lagrangian yields the interaction terms of the electroweak interaction for left-
...
fields observed in nature. The fields $W_\mu^1$ and $W_\mu^2$ are associated
with charged-current interactions noting that $\sigma_1$ and $\sigma_2$ are
anti-diagonal matrices. Similarly, $W_\mu^3$ is associated with a
neutral-current interaction given $\sigma_3$ is a diagonal matrix. The physical
fields of the charged-current interaction can be identified as
\begin{align*}
  W_\mu^\pm = \frac{1}{\sqrt{2}} (W_\mu^1 \mp i W_\mu^2) \,\text{.}
\end{align*}
% in analogy to the weak isospin ladder operators.
Similarly, the physical fields describing the neutral-current interactions via
...
boson couplings are introduced into the theory.\todo{Context?}
...
embed the doublet of complex scalar fields in the electroweak theory with a
$SU(2)_{\text{L}}\otimes U(1)_Y$ symmetry. To fulfil the gauge invariance of the
electroweak theory, the potential can only depend on $\phi^\dagger \phi$. One
such choice is
\begin{align}
