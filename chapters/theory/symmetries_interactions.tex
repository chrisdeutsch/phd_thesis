...
This is illustrated for the case of the Lagrangian of the Dirac field of mass $m$
given by
\begin{align}
...
quantum electrodynamics (QED), which describes electromagnetic interactions. The
...
electromagnetic and weak interaction. These are introduced in
...
are written in terms of the three component objects
\begin{align*}
  \psi =
  \begin{pmatrix}
    q_\text{r} \\
...
commute in general, that is, the symmetry group is non-Abelian. The commutation
...
\item[Colour confinement] Due to the dynamics of the gluon self-interactions,
  ...
  quark--antiquark pair from the vacuum. This process repeats itself until only
  quarks or gluons bound into colourless composite particles (colour singlet
  states) remain. The most prevalent bound states of quarks are (anti-)baryons
...
weak interaction violates parity symmetry maximally since it only couples to
...
of SM fermions is chosen in anticipation of an $SU(2)$ symmetry.
...
between the upper and lower component of the $SU(2)_{\text{L}}$ doublets, an
$SU(2)_{\text{L}}$ transformation would violate the $U(1)_Q$ symmetry of
QED. Therefore, the weak hypercharge is defined such that both components of an
...
generator of the group instead. The $U(1)_Q$ symmetry of QED is later recovered
in a process referred to as \emph{electroweak symmetry breaking} (EWSB).
...
embed the doublet of complex scalar fields into the electroweak theory with an
...
shape of the potential is illustrated in \Cref{fig:mexican_hat} for a simplified
...
full Lagrangian still possesses an $SU(2)_{\text{L}} \otimes U(1)_Y$ symmetry,
...
as\footnote{There exists no consensus regarding the definition of
  \lambdahhh and \lambdahhhh. In this thesis, a convention is adopted
  such that the Higgs potential can be expressed as
  \begin{align*}
    V(H) = \frac{m_{H}^2}{2} H^2 + \frac{\lambdahhh}{3!} H^3 + \frac{\lambdahhhh}{4!}
    H^4 \,\text{.}
  \end{align*}
}
\begin{align*}
  \lambdahhh \coloneqq \frac{3 m_{H}^2}{\varv} \qquad \text{and} \qquad \lambdahhhh \coloneqq \frac{3 m_{H}^2}{\varv^2} \,\text{.}
\end{align*}
...
\end{align}
The first term of \Cref{eq:higgs_covariant_derivative} represents the kinetic
...
for electrons, up quarks, and down quarks are denoted as $e_{\text{R}}$,
$u_{\text{R}}$, and $d_{\text{R}}$, respectively. Moreover, the coupling
constants of the Yukawa interactions, which are free parameters of the theory,
are given by $y_e$, $y_u$, and $y_d$. Lastly, $\text{h.c.}$ represents the
hermitian conjugate of the preceding terms. After EWSB and in unitary gauge
