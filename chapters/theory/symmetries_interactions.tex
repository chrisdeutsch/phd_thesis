...
fermions of different flavour that differ by one unit in electric charge. As a
result, the construction of a gauge theory of the weak interaction that respects
local gauge invariance and describes the masses of gauge bosons and fermions
requires additional mechanisms that were not needed for the description of QED
and QCD.
