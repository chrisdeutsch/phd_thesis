...
sector is well-established and the two parameters of the BEH potential, $\varv$
and $m_{H}$, are determined with high precision.\footnote{The VEV was known
  prior to the discovery of the Higgs boson through measurements of the muon
  lifetime, which determines the effective coupling constant $G_{\text{F}}$ of
