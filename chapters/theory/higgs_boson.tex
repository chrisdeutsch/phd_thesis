...
The Higgs boson is the only scalar particle in the SM. It is massive with
...
The second largest SM \HH production mode is VBF. The leading order diagrams of
the this production mode are depicted in \Cref{fig:dihiggs_vbf_feyn}. The
diagrams involve the coupling of the Higgs boson to vector bosons, $g_{HVV}$,
the quartic $HHVV$ coupling, $g_{HHVV}$, and the Higgs boson self-coupling. A
characteristic feature of the VBF production mode is the presence of two
additional jets originating from the fragmentation and hadronisation of the
final state quarks. The predicted SM \HH production cross-section via VBF is
\begin{align*}
  \sigma(\pp \to qqHH) = \SI{1.726}{\femto\barn}
\end{align*}
at $\text{N}^3\text{LO}$~\cite{Dreyer:2018qbw,LHCHWGHH}. Due to the small
cross-section, the VBF production mode is currently of lesser relevance to probe
the nature of the Higgs boson self-coupling.
...
considered for the remainder of this thesis.
...
\item[The \bbtautau channel] has a reduced branching ratio of
  \SI{7.3}{\percent}, however, the presence of two \tauleptons provides a decent
...
\item[The \bbyy channel] has a very small branching ratio of
  ...
  select signal events. Additionally, the reconstruction of the di-photon
  invariant mass, $m_{\gamma\gamma}$, has a typical resolution of
  \SIrange{1}{2}{\GeV} in the ATLAS and CMS experiments at the
