...
\begin{figure}[htbp]
  ...
  \caption[Feynman diagrams of Higgs boson pair production via \ggF.]{Feynman
    diagrams of Higgs boson pair production via \ggF at leading order. The
    diagrams (a) and (b) are commonly referred to as the box and triangle
    diagrams, respectively. The Higgs boson self-coupling is denoted as
...
\begin{figure}[htbp]
  ...
  \caption[Feynman diagrams of Higgs boson pair production via VBF.]{Feynman
    diagrams of Higgs boson pair production via VBF at leading order.}%
...
\begin{figure}[htbp]
  ...
  \caption[Branching ratios for a system of two SM Higgs bosons.]{Branching
