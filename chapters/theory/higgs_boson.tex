...
parameters of the EWSB %, $\varv$ and $m_H$,
...
of a system of two Higgs bosons is given in \Cref{fig:hh_branching_ratios}.
...
\begin{figure}[htbp]
  ...
  \caption[Branching ratios of a system of two Higgs bosons.]{Branching ratios
    of the decay of a system of two Higgs bosons. The Higgs boson branching
    ratios are taken from Ref.~\cite{deFlorian:2016spz_book} and
    assume~$m_{H} = \SI{125.0}{\GeV}$. The figure is based on
    Ref.~\cite{Veatch:2022uzz}.}%
...
\item[The \bbtautau channel] has a reduced branching ratio of
  ...
  \ttbar, \Zjets, multi-jet, and single-Higgs-boson events. Searches for SM \HH
  in the \bbtautau channel often focus on final states with one leptonic and one
  hadronic \tauleptonC decay (\lephad), and final states with two hadronic
  \tauleptonC decays (\hadhad). These final states cover almost \SI{90}{\percent}
