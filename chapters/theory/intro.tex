...
As mentioned previously, the naive form of including fermion mass terms in the
SM Lagrangian
\begin{align*}
  \lagrange_{\text{mass}}^{\text{fermion}} = - m \bar{\psi} \psi = - m [ \bar{\psi}_\text{R} \psi_\text{L} + \bar{\psi}_\text{L} \psi_\text{R} ]
\end{align*}
is not gauge invariant with respect to the $SU(2)_{\text{L}} \otimes U(1)_Y$
symmetry group. Instead, the fermion mass terms in the SM are generated
dynamically through electroweak symmetry breaking to ensure gauge invariance.

A gauge invariant Lagrangian is introduced coupling the massive fermions to the
doublet of complex scalar fields $\phi$ or a conjugate doublet defined as
$\phi_{\text{c}} = i \sigma_2 \phi^*$.

Exemplary for the first fermion generation:
\begin{align*}
  \lagrange_{\text{Yukawa}} =
  - y_e \bar{L} \phi e_{\text{R}}
  - y_d \bar{Q} \phi d_{\text{R}}
  - y_u \bar{Q} \phi_{\text{c}} u_{\text{R}}
  + \text{h.c.}
\end{align*}
(analogously for the second and third fermion generations).

After electroweak symmetry breaking this becomes in unitary gauge:
\begin{align}
...
\end{align}
where $y_f$ is the Yukawa coupling constant for fermion $f$. The process of EWSB
generates mass terms for the fermions
\begin{align*}
...
\todo[inline]{Mention mixing according to CKM matrices?}


\section{The Higgs Boson and Higgs Boson Pair Production}
