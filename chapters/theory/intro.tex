...
referred to as the Higgs boson. The terms cubic and quadratic in the scalar
field yield self-interactions between Higgs bosons with coupling
strengths\footnote{TODO: Explain mysterious factorial factors} of
\begin{align*}
  g_{HHH} = \frac{3 m_{H}^2}{v} \qquad \text{and} \qquad g_{HHHH} = \frac{3 m_{H}^2}{v^2} \,\text{.}
\end{align*}
The Feynman vertices of the Higgs boson self-interaction vertices are depicted
in \Cref{fig:vertex_hhh,fig:vertex_hhhh}, respectively.
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{0.33\textwidth}
    \centering
    \includegraphics{feynman_graphs/higgs_hhh}
    \subcaption{}
    \label{fig:vertex_hhh}
  \end{subfigure}%
  \begin{subfigure}{0.33\textwidth}
    \centering
    \includegraphics{feynman_graphs/higgs_hzz}
    \subcaption{}
  \end{subfigure}%
  \begin{subfigure}{0.33\textwidth}
    \centering
    \includegraphics{feynman_graphs/higgs_hww}
    \subcaption{}
  \end{subfigure}
  ...
  \begin{subfigure}{0.33\textwidth}
    \centering
    \includegraphics{feynman_graphs/higgs_hhhh}
    \subcaption{}
    \label{fig:vertex_hhhh}
  \end{subfigure}%
  \begin{subfigure}{0.33\textwidth}
    \centering
    \includegraphics{feynman_graphs/higgs_hhzz}
    \subcaption{}
  \end{subfigure}%
  \begin{subfigure}{0.33\textwidth}
    \centering
    \includegraphics{feynman_graphs/higgs_hhww}
    \subcaption{}
  \end{subfigure}
...
terms for the $W^\pm$ and $Z$ bosons while leaving the photon
massless. Moreover, using the four parameters of the electroweak theory (e.g.\
$g$, $g^\prime$, $m_{H}$, $v$) the masses of the bosons can be obtained from the
Lagrangian\footnote{TODO: Explain mysterious factor of two for the W mass term.}
such that
\begin{align*}
