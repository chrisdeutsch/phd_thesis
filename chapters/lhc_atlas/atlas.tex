...
for signatures of rare physics processes, such as the presence of charged
leptons with large transverse momenta. A multitude of different event
selections, usually referred to as \emph{triggers}, are implemented in the ATLAS
trigger system, targeting signatures of different physics processes. The
...
\SI{1.2}{\kilo\hertz}~\cite{TRIG-2019-04} which could be recorded for later
analysis (\emph{offline}).
...
reduced down to \SI{100}{\kilo\hertz}~\cite{TRIG-2019-04} by the L1 trigger. If
an event is accepted, all sub-detectors of the ATLAS experiment are read-out and
