...
endcap ($1.375 < |\eta| < 3.2$), and forward ($3.1 < |\eta| < 3.9$)
...
The hadronic calorimeter is divided into a barrel ($|\eta| < 1.0$), extended
barrel ($0.8 < |\eta| < 1.7$), endcap ($1.5 < |\eta| < 3.2$), and forward
($3.1 < |\eta| < 3.9$) region~\cite{PERF-2007-01}.  The barrel and extended
barrel calorimeter consists of alternating steel plates and plastic scintillator
tiles. The scintillators are connected via optical fibres to photomultiplier
tubes for read-out. The hadronic endcap calorimeter (HEC) and forward
calorimeter consist of LAr-filled ionisation chambers with copper and tungsten
absorbers, respectively. The hadronic calorimeter is also segmented laterally
and longitudinally, although with reduced granularity compared to the
...
\begin{figure}[htbp]
  ...
  \caption{Muon subsystems. Image taken from Ref.~\cite{PERF-2007-01}.}%
