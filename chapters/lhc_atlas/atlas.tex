...
chambers filled with liquid argon or plastic scintillator tiles connected to
...
\begin{itemize}
\item Divided in barrel ($|\eta| < 1.475$) and endcap ($1.375 < |\eta| < 3.2$)
  part
\item Lead absorber plates \& kapton electrodes gaps filled with liquid argon
  (LAr) -> ionisation chamber
\item In the central region ($|\eta| < 2.5$), segmented into three layers in
  radial direction
\item Pre-sampler in $|\eta| < 1.8$
\end{itemize}
...
\begin{itemize}
\item Scintillator tile calorimeter covering $|\eta| < 1.7$
\item Steel absorbers
\item Plastic scintillator tiles
\item Endcap (copper/LAr) and forward (copper/tungsten/LAr) region uses LAr
\end{itemize}
