...
\item[BRT-based TES] The BRT-based TES is derived from \tauhadvis energy
  ...
  for \tauhadvis with transverse energies below
  ...
  \taulepton decay mode. In addition, \pTLC is included as an input since the
  calorimeter-based estimate of \tauhadvis \pT is superior to the estimate from
  Tau Particle Flow for \tauhadvis at high-\pT.
...
Other objects are frequently reconstructed as \tauhadvis candidates since
\tauhadvis reconstruction provides limited rejection. The most common sources of
\tauhadvis candidates not originating from hadronic decays of \tauleptons are
quark- and gluon-initiated jets and electrons. The task of rejecting these
candidates, referred to as \faketauhadvis, is called \tauid. \Cref{sec:tauid}
discusses \tauid in detail with a focus on rejecting \tauhadvis candidates
originating from quark- or gluon-initiated jets.
