...
Particles produced in \pp-collision events are reconstructed using their signals
...
identify higher-level objects corresponding to the signatures of particles such
as electrons, muons, \tauleptons, or quarks/gluons in the form of jets. These
objects, often referred to as \emph{physics objects}, provide estimates of the
four-momentum and other properties of the underlying particle.

The same reconstruction techniques are used for simulated events and data
recorded with the detector. Additional calibrations are applied to ensure that
the

This section provides a summary of the object reconstruction relevant for the
