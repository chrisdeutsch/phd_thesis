...
$\dR < 0.2$ of the jet axis and pass $\pT > \SI{1}{\GeV}$ and track quality
criteria based on the minimum number of hits in the pixel and SCT detector are
selected. The PV that maximises the scalar sum of track \pT of all tracks
associated to the vertex and passing the selections is associated to the jet.
