...
\SI{1.5e-12}{\seconds}~\cite{pdg2020} and thus, assuming a $B$ meson momentum of
...
\item[Track impact parameter based:] Due to the relatively large mass of
  ...
  PV of the hard interaction compared to promptly produced charged particles.
...
The $b$-tagging algorithms used at the ATLAS experiment are based on the
