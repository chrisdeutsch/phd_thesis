...
by jet algorithms which combine particles, or other objects with a defined
four-momentum, into clusters to reconstruct jets. In the ATLAS experiment, the
anti-\kt jet clustering algorithm~\cite{Cacciari:2008gp} is most frequently
used.
