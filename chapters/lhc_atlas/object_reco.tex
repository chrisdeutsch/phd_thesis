...
in \pp-collisions at the LHC. Similar to other quarks except the top quark, a
$b$-quark produced in a hard scattering interaction leads to the formation of a
jet, referred to as a $b$-jet. A distinct feature of $b$-jets is the presence of
a $b$-hadron with a mass exceeding \SI{5}{\GeV}~\cite{pdg2020}. The $b$-hadrons
are short-lived and will, after traversing a short but measurable distance in
the ATLAS detector, decay via the weak interaction. Decays of $b$-hadrons
predominately produce final states containing a $c$-hadron, which decay
similarly to $b$-hadrons but on a shorter timescale.

The task of identifying $b$-jets is called $b$-tagging. The main feature
exploited by $b$-tagging is the decay of the

displaced decay of a heavy hadron
