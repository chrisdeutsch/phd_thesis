...
object reconstruction relevant for the remainder of this thesis.
...
efficiency outside the acceptance of ID track reconstruction. The
...
maximising this sum is associated to the \tauhadvis candidate and is referred to
as the \emph{tau vertex}.
