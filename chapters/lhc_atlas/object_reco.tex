...
curvature of the track. After the location of the hard interaction is
reconstructed, tracks are often re-parameterised using this point as a reference
...
% The track reconstruction algorithms of the ATLAS experiment at the end of
% Run~2 only provide tracks within the acceptance of the tracking detectors,
% $|\eta| < 2.5$, and with $\pT > \SI{500}{\MeV}$.
...
the process is repeated on all unassociated tracks. Finally, the PV with the
largest sum of $\pT^2$ of associated tracks that has at least two tracks with
$\pT > \SI{500}{\MeV}$ is selected as the PV of the hard interaction. Other
