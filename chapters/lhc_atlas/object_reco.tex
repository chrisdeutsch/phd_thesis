...
A description of photon reconstruction or other specialised reconstruction
techniques is omitted to focus on the objects that are most important to the
work presented in this thesis.

Details on the objects used for the studies presented in \Cref{} are given in
