This chapter describes a new algorithm used at the ATLAS experiment to
...
but rather to correctly reconstruct \truetauhadvis.%  More generally,
% the process of distinguishing between true- and \faketauhadvis is
% called \tauid.
...
\item[Collimated daughter particles] The \tauhadvis candidates
  ...
  % Maybe define 'isolation'? -> Lack of activity outside of a core
  % region?
