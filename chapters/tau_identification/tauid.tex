...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{0.48\textwidth}
    ...
    \includegraphics[width=0.85\textwidth]{tauid/invars/invars_sumpttrkfrac_1P}
    \subcaption{}
  \end{subfigure}%
  \begin{subfigure}{0.48\textwidth}
    \centering

    \includegraphics[width=0.85\textwidth]{tauid/invars/invars_absipsigleadtrk_1P}
    \subcaption{}
  \end{subfigure}
  ...
  \begin{subfigure}{0.48\textwidth}
    ...
    \includegraphics[width=0.85\textwidth]{tauid/invars/invars_masstrksys_3P}
    \subcaption{}
  \end{subfigure}%
  \begin{subfigure}{0.48\textwidth}
    \centering

    \includegraphics[width=0.85\textwidth]{tauid/invars/invars_trflightpathsig_3P}
    \subcaption{}
  \end{subfigure}
