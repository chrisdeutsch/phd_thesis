...
\Cref{fig:tauid_truetau_eff} for the four working points in bins of
...
\Cref{fig:tauid_truetau_eff_a,fig:tauid_truetau_eff_b}. The
...
is compared in~\Cref{fig:tauid_faketau_rej}. The comparison is
