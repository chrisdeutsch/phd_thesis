...
\begin{table}[htbp]
  ...
  \caption[Input variables used for RNN \tauid.]{Summary of input variables used
    for RNN \tauid. The local hadronic calibration~\cite{PERF-2014-07} is used
    to calibrate jets, clusters, and \tauhadvis candidates unless otherwise
    noted. Definitions of geometrical topo-cluster moments measuring the
    location and shape of clusters ($\lambda$, $\langle \lambda^2 \rangle$,
...
in~\Cref{fig:tauid_low_level_variables_track}, are included. Among the most
