...
derived using the calorimeter-based \tauhadvis \pT estimate at LC scale which is
now superseded by a multivariate method combining information from the
...
simulation and the central value of the data-driven measurement.\footnote{A
  similar level of agreement is observed in the \tauhadvis efficiency
  measurements for the BDT-based algorithm.} Both agree within the statistical
and systematic uncertainties of the measurement, showing acceptable modelling of
the \tauid decisions thresholds in simulation even after including low-level
