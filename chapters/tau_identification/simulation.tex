...
simulated $\gammastar \to \tautau$ and di-jet events are used,
...
\item The number of \emph{core} tracks (cf.\ REF\todo{Reference tau
    reco.\ section.}) of the \tauhadvis candidate, \Ntracks, is either
...
\item The \tauhadvis candidate needs to be within $|\eta| < 2.5$ but
  outside of the transition region between barrel and endcap
...
spectrum of \tauhadvis candidates from di-jet events, depicted in
...
\begin{figure}[htbp]
  ...
  \caption{Transverse momentum distributions of 1- and 3-prong
    \tauhadvis candidates in $\gammastar \to \tautau$ (a) and di-jet
