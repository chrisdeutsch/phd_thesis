...
the ATLAS detector is simulated for all generated events~\cite{SOFT-2010-01} and
subsequently events are reconstructed from the simulated detector response using
the \textsc{Athena} software suite~\cite{ATL-SOFT-PUB-2021-001}.
