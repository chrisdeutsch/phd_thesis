...
able to decay into pairs of Higgs bosons. Such scenarios are studied by
...
a function of the self-coupling modifier \klambda, which is defined as
$\klambda = \lambdahhh / \lambdahhh^{\text{SM}}$, where $\lambdahhh^{\text{SM}}$
is the self-coupling predicted by the SM. The upper limits on the non-resonant
\HH production cross section is compared to the theoretical predictions yielding
