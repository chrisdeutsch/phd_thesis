...
observables of discriminants used to select signals from
...
\item The observables of the most signal-like bins are expected to have little
  ...
  case, the PNN cannot properly distinguish between adjacent mass points leading
  to correlations between observables of up to \SI{75}{\percent}.

\end{itemize}
The correlation matrices in the \lephad SLT and LTT channels show similar
features.

% ^ MERGE WITH THIS The expected correlation between observables of the high \mX
% discriminants are shown in~\Cref{fig:correlation_matrix_observables_high} for
% the \hadhad channel. As previously noted, the signal extraction method is
% unable to separate the signatures of signal-like events at high \mX. This is
% reflected in the correlation coefficient of the observables for the most
% signal-like bins of adjacent mass points reaching values of up to
% \SI{75}{\percent}. The correlation matrices estimated for the \lephad SLT and
% LTT channels yield similar results.
