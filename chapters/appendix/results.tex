...
\begin{figure}[htbp]
  ...
  % TODO: Add short...
  \caption[Post-fit pulls and rankings of NPs.]{Post-fit pulls and rankings of NPs


    for the search  scalar resonances with $\mX = \SI{300}{\GeV}$.


    Post-fit NP pulls and rankings for the



    Ranking for $\mX = \SI{300}{\GeV}$ for the combination of all channels.}
\end{figure}
