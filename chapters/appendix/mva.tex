...
\item[\pTmissAbs $\phi$ centrality] A measure of the relative angular position of
  \pTmiss and visible \tauleptonC decay products (electrons, muons, or
  \tauhadvis) in the transverse plane. It is defined as
  % The measurement is relative to the line bisecting the azimuthal angle
  % between the pair of visible \tauleptonC decay products and is defined
  ...
  azimuthal angle of \pTmiss and visible \tauleptonC decay products,
  ...
  azimuthal angle spanned by the visible \tauleptonC decay products. It reaches a
  ...
  visible \tauleptonC decay products, it takes a value of 1.
