...
HL-LHC~\cite{DiMicco:2019ngk}. One of the main goals of post-LHC colliders, for
...
with a precision of the level of \SI{10}{\percent} and below.

% ~\cite{deBlas:2019rxi}.

% The measurement of the Higgs boson self-coupling with unprecedented precision

% second half of the 21\textsuperscript{st} century

% The measurement of the Higgs boson self-coupling with unprecedented precision of
% about \SI{10}{\percent}~\cite{deBlas:2019rxi} is one of the main goals of a
% post-LHC collider such as the FCC~\cite{}, ILC~\cite{}, or CLIC~\cite{}.
