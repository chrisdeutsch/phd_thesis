...
highest expected sensitivity to SM~\HH production of any single channel of the
...
on the SM~\HH signal strength at \SI{95}{\percent}~CL of 2.4~\cite{HDBS-2022-03}
...
\pp~collision dataset. Moreover, the Higgs boson self-coupling constant measured
with a precision of the order of \SI{50}{\percent} at the
HL-LHC~\cite{DiMicco:2019ngk}. More precise measurements of the Higgs boson
self-coupling.....

% will require particle colliders beyond the HL-LHC.

% higher-order corrections to Higgs boson production at Higgs boson factories
% such as ILC.
...
% More precise measurements of the Higgs boson self-coupling

% successor of the HL-LHC or a dedicated Higgs boson factory such as ILC~\cite{}
% or CLIC~\cite{}.
