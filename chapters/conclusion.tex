...
\klambda. Based on the observed (expected) upper limits on the cross section at
\SI{95}{\percent}~CL, the Higgs boson self-coupling modifier is constrained to
be within $-2.4 \leq \klambda \leq 9.2$
...
exists. Instead, searches in the \bbbb, \bbtautau, and \bbyy channels are
complementary. Consequently, combinations of these and other channels are
