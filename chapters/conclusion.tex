...
% COMBINATION
At present, a single golden channel for searches for non-resonant \HH production
does not exists. Instead, the \bbbb, \bbyy, and \bbtautau channels are
...
strength and the Higgs boson self-coupling. These combinations were performed by
the ATLAS and CMS collaborations after Run~2 of the LHC, yielding observed upper
limits on the SM~\HH signal strength of 2.4 and 3.4,
...
% combination of the most sensitive channels by the ATLAS and CMS collaborations
...
% In~\cite{ATL-PHYS-PUB-2015-046} the HL-LHC prospects claim to set an upper
% limit of $4.3 \times \sigma_\text{SM}$. 6 years later we already exceed this
% prospect.
