...
candidates.
% In addition, the improvement in \faketauhadvis rejection exceeds
% \SI{100}{\percent} for candidates with $\pT > \SI{70}{\GeV}$.
...
% SM HH
The search for SM~\HH production is optimised for the dominant \ggF production
...
\todo[inline]{Check sentences starting with: ``In the search, ...'' vs ``In the
  search ...'' (or similar)}
...
\todo[inline]{Add information of $\pT(Z)$ dependence of \ZHF normalisation.}

\todo[inline]{Add plots for basic kinematic variables in the \hadhad signal
  region.}
