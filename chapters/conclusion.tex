...
and the Higgs boson self-coupling constant. The ATLAS and CMS collaborations
performed combinations of analyses of Run~2 data, yielding upper limits on the
SM~\HH signal strength at \SI{95}{\percent}~CL of 2.4~\cite{HDBS-2022-03} and
3.4~\cite{CMS-HIG-22-001}, respectively, outperforming any individual search
channel. Similarly, the best experimental constraints on the Higgs boson
self-coupling are obtained by combinations of multiple channels. The Higgs boson
