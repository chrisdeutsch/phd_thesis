...
\begin{tabular}{lllllll}
  ...
  \midrule
  $H \to \tautau$ (ggF) & \POWHEGBOX[v2]~\cite{Hamilton:2013fea,Hamilton:2015nsa} & \NNPDF[3.0nnlo] & NNLO & \PYTHIA[8.212] & \AZNLO~\cite{STDM-2012-23} & N$^3$LO (NLO EW)~\cite{deFlorian:2016spz_book} \\
  $H \to \tautau$ (VBF) & \POWHEGBOX[v2]~\cite{Nason:2009ai} & \NNPDF[3.0nlo] & NLO & \PYTHIA[8.230]  & \AZNLO & NNLO approx.\ (NLO EW)~\cite{deFlorian:2016spz_book} \\
  $H \to \tautau / \bbbar$ ($WH$) & \POWHEGBOX[v2] & \NNPDF[3.0nlo] & NLO & \PYTHIA[8.212] & \AZNLO & NNLO (NLO EW)~\cite{deFlorian:2016spz_book} \\
  $H \to \tautau / \bbbar$ ($q\bar{q}/qg \to ZH$) & \POWHEGBOX[v2] & \NNPDF[3.0nlo] & NLO & \PYTHIA[8.212] & \AZNLO & NNLO (NLO EW)$^\dagger$~\cite{deFlorian:2016spz_book} \\
  $H \to \tautau / \bbbar$ ($gg \to ZH$) & \POWHEGBOX[v2] & \NNPDF[3.0nlo] & LO & \PYTHIA[8.244]/\textsc{8.212} & \AZNLO & NLO+NLL~\cite{deFlorian:2016spz_book} \\
  $H \to \tautau / \bbbar$ ($\ttbar H$) & \POWHEGBOX[v2] & \NNPDF[3.0nlo] & NLO & \PYTHIA[8.230]  & A14 & NLO (NLO EW)~\cite{deFlorian:2016spz_book} \\
  \bottomrule
\end{tabular}
