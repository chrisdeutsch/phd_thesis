\begin{tabular}{lS[table-format=4.1]S[table-format=3.3]S[table-format=4.3]S[table-format=4.2]S[table-format=4.1]S[table-format=4.1]}
  ...
  \multicolumn{7}{l}{\footnotesize $*$: At least two \tauhadvis candidates  with $\pT > \SI{33}{\GeV}$ (\SI{23}{\GeV}), $1 \leq \Ntracks + \Ntracks^{\text{iso.}} \leq 8$, and one or more \tauhadvis passing loose identification.} \\
  \multicolumn{7}{l}{\footnotesize $\ddag$: $\geq 2$ (anti-)\tauhadvis candidates passing the \tauhadvis selection (cf.~\Cref{sec:object_reconstruction}) with a relaxed \tauid requirement of $\rnnscore > 0.01$.}\\
  \bottomrule
\end{tabular}
