\begin{tabular}{lS[table-format=4.1]S[table-format=3.2]S[table-format=4.2]S[table-format=4.2]S[table-format=4.1]}
  \toprule
  & \multicolumn{5}{c}{Expected number of events} \\
  \cmidrule{2-6}
