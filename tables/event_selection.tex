{
  ...
  \begin{tabular}{C{0.225\textwidth}C{0.225\textwidth}C{0.225\textwidth}C{0.225\textwidth}}
    ...
    \midrule
    \multicolumn{4}{c}{\textbf{$e$ / $\mu$ selection}} \\
    \midrule
    \multicolumn{2}{c}{No loose $e$ or $\mu$} & \multicolumn{2}{c}{Exactly one loose $e$ or one loose $\mu$} \\[0.5em]
                                                 && \multicolumn{2}{c}{$e$ is passes tight identification or} \\
                                                 && \multicolumn{2}{c}{$\mu$ passes medium identification and $|\eta| < 2.5$} \\[0.5em]
    ...
    \midrule
    \multicolumn{2}{c}{Exactly two loose \tauhadvis} & \multicolumn{2}{c}{Exactly one loose \tauhadvis} \\[0.5em]
                                                 && \multicolumn{2}{c}{$|\eta| < 2.3$} \\[0.5em]
    $\pT > 100\text{--}180 \, (25)\,\si{\GeV}$ & $\pT > 40 \, (30)\,\si{\GeV}$ & & $\pT > \SI{30}{\GeV}$ \\
    \midrule
    \multicolumn{4}{c}{\textbf{Central jet selection ($|\eta| < 2.5$)}} \\
    \midrule
    ...
    \midrule
    \multicolumn{4}{c}{Event is selected by a trigger and trigger requirements (cf.~\Cref{sec:hadhad_trigger_selection}) are fulfilled} \\[0.25em]
